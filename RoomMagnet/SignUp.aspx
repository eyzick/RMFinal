                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="hoAddress" runat="server" Class="form-control" placeholder="1234 Main St"></asp:TextBox>
                                </div>
                                <div class="form-group">
                                    <label for="inputDOB">Date of Birth</label>

                                    <asp:TextBox ID="hoDOB" runat="server" Class="form-control" type="date"></asp:TextBox>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputCity">City</label>
                                        <asp:TextBox ID="hoCity" runat="server" Class="form-control" placeholder="City"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="inputState">State</label>


                                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" Style="height: auto">
                                    ...
                                    <div class="form-group col-md-3">
                                        <label for="inputZip">Zip</label>
                                        <asp:TextBox ID="hoZip" runat="server" Class="form-control" placeholder="Zip"></asp:TextBox>
                                    </div>
